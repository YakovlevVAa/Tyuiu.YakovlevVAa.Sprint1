...
namespace Tyuiu.YakovlevVAa.Sprint1.Task2.V16
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Формулировка задания: Известен радиус круга. Вычислить примерный        *");
            Console.WriteLine("* периметр круга. Ответ округлите до 3 знаков после запятой.              *");
            Console.WriteLine("*                                                                         *");
            Console.WriteLine("***************************************************************************");
